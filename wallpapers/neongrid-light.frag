...
//Colors
#define GRID_COLOR_1 vec3(0.969, 0.980, 0.973) // neongrid: near-white field
#define GRID_COLOR_2 vec3(0.039, 0.380, 0.157) // neongrid: deep green wireframe
...
vec3 Shade(MarchResult hit, vec3 direction, vec3 camera)
{
    ...
    //Distance fog
    color = mix(color, GRID_COLOR_1, smoothstep(0.0, MAX_DIST*0.9, hit.dist)); // neongrid: fog to field, not to black
